...
def _clean_data(
    ...
    if data_final is not None:
        ...
        if only_alive:
            ...
            if "etatAdministratifEtablissement" in data_final.columns:
                data_final = data_final[
                    data_final["etatAdministratifEtablissement"] == "A"
                ]
            if "etatAdministratifUniteLegale" in data_final.columns:
                data_final = data_final[
                    data_final["etatAdministratifUniteLegale"] == "A"
                ]
            ...
            if "categorieJuridiqueUniteLegale" in data_final.columns:
                if (
                    ...
                    try:
                        ...
                        data_legal = data_legal.rename(
                            columns={
                                "code": "categorieJuridiqueUniteLegale",
        ...
        list_all_na_col = [
            col for col in data_final.columns if all(pd.isna(data_final[col]))
        ]
        list_first_col = [
